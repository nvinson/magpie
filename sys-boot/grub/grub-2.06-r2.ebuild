...
SLOT="2/${PVR}"
IUSE="device-mapper doc efiemu +fonts mount nls sdl +stack-protection test +themes truetype libzfs"
...
grub_configure() {
	...
	local myeconfargs=(
		...
		$(use_enable stack-protection stack-protector=strong)
...
src_configure() {
	...
	filter-flags -pie -fPIC -fPIE -fpic -fpie -fstack-protector*
