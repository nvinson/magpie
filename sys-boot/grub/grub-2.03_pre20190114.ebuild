...
EGIT_COMMIT=ed087f0460516737e174222f01e2bf6ccbd45674
...
SLOT="2/${PVR}"
IUSE="abi_ppc_32 abi_ppc_64 debug device-mapper doc efiemu +fonts kernel_linux libzfs mount multislot nls sdl static test +themes truetype"
...
COMMON_DEPEND="
	...
	abi_ppc_32? ( >=sys-apps/ibm-powerpc-utils-1.3.5 )
	abi_ppc_64? ( >=sys-apps/ibm-powerpc-utils-1.3.5 )
"
