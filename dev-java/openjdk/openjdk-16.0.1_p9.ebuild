...
SRC_URI="https://github.com/${PN}/jdk16u/archive/refs/tags/jdk-${MY_PV}.tar.gz -> ${P}.tar.gz"
...
src_configure() {
	...
	local version_string="${PV%_p*}"
	local version_build="${PV#${version_string}}"
	version_build=${version_build#_p}
